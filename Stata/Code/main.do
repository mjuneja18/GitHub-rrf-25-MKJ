...
*******************************************************************************/
	...
	* Add file paths to DataWork folder and the Github folder for RRF2024
	if "`c(username)'" == "wb624368" {
        global onedrive "C:\Users\wb624368\OneDrive - WBG\Documents\4 Learning\1 Data Career Stream\Transparent and Credible Analytics\DataWork"
		global github 	"C:\Users\wb624368\Downloads\GitHub-rrf-25-MKJ"
    }
